<template>
	<div>
		...
		<a-table
			...
			:loading="isLoading"
			:pagination="false"
			key="table-token-contract"
		>
			<!--	 title		-->
			<div class="token-contract-table__title" slot="token-contract_title">
				Token Contracts
			</div>
			...
			<div slot="isCoin" slot-scope="text, { isCoin }">
				<p>{{ isCoin ? "Yes" : "No" }}</p>
			</div>
...
export default Vue.extend({
		...
		columns(): UiTableColumn[] {
			return [
				...
				},
				{
					...
					dataIndex: "isCoin",
					key: "isCoin",
					scopedSlots: { customRender: "isCoin" }
				},
				{
					title: "Actions",
					dataIndex: "actions",
	...
	methods: {
		...
		...mapActions({
			fetchList: "parsing-jobs/fetchTokenContractList",
			fetchGameList: "games/fetchGames",
			saveContract: "parsing-jobs/saveTokenContract",
			deleteContract: "parsing-jobs/deleteTokenContract"
		}),
		setWidth(): void {
